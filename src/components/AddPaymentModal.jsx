...
const clientOptions = [
  { value: '1', label: 'Sarah Johnson', initials: 'SJ' },
  { value: '2', label: 'David Wilson', initials: 'DW' },
  { value: '3', label: 'Emma Davis', initials: 'ED' },
  { value: '4', label: 'James Miller', initials: 'JM' },
  { value: '5', label: 'Olivia Brown', initials: 'OB' },
  { value: '6', label: 'Michael Taylor', initials: 'MT' },
  { value: '7', label: 'Sophia Anderson', initials: 'SA' },
  { value: '8', label: 'William Martinez', initials: 'WM' },
];
...
export default function AddPaymentModal({ open, onOpenChange }) {
  ...
  const handleSubmit = (e) => {
    ...
    const client = clientOptions.find(c => c.value === formData.clientId);
    const paymentData = {
      ...formData,
      clientName: client?.label,
      clientInitials: client?.initials,
      amount: parseFloat(formData.amount),
      invoiceNo: `INV-2025-${String(Math.floor(Math.random() * 1000)).padStart(3, '0')}`,
    };
